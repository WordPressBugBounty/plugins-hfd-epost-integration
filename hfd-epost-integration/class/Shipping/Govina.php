...
class Govina extends \WC_Shipping_Method
{
    const METHOD_ID = 'betanet_govina';
    ...
    public function __construct($instanceId = 0)
    {
        ...
        $this->method_title = __('Govina', 'hfd-integration');
        $this->method_description = __('Govina', 'hfd-integration');
        $this->supports = array(
            'shipping-zones',
            'instance-settings',
    ...
    public function init()
    {
        ...
        $this->instance_form_fields = array(
            ...
            'title' => array(
                'title' => __('Govina', 'hfd-integration'),
                'type' => 'text',
                'default' => __('Govina', 'hfd-integration'),
                'desc_tip' => true
            ),
            'shipping_fee' => array(
