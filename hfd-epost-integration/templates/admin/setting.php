...
$hfd_sync_order_items = $setting->get( 'hfd_sync_order_items' );
$hfd_take_varaible_sku = $setting->get( 'hfd_take_varaible_sku' );
...
if( empty( $hfd_take_varaible_sku ) ){
    ...
    <form method="post" action="admin-post.php">
        ...
        <table class="form-table">
            <tbody>
				...
				<tr valign="top">
                    <th scope="row"><?php esc_html_e( 'Order Sync Items', 'hfd-integration' ); ?></th>
                    <td>
						<div>
							<input type="radio" name="hfd_sync_order_items" value="yes" <?php checked( $hfd_sync_order_items, 'yes' ); ?> /> <?php esc_html_e( 'Yes', 'hfd-integration' ); ?>
						</div>
						<div>
							<input type="radio" name="hfd_sync_order_items" value="no" <?php checked( $hfd_sync_order_items, 'no' ); ?> /> <?php esc_html_e( 'No', 'hfd-integration' ); ?>
						</div>
                    </td>
                </tr>
				<tr valign="top">
                    <th scope="row"><?php esc_html_e( 'Take Variable SKU', 'hfd-integration' ); ?></th>
                    <td>
						<div>
							<input type="radio" name="hfd_take_varaible_sku" value="yes" <?php checked( $hfd_take_varaible_sku, 'yes' ); ?> /> <?php esc_html_e( 'Yes', 'hfd-integration' ); ?>
						</div>
						<div>
							<input type="radio" name="hfd_take_varaible_sku" value="no" <?php checked( $hfd_take_varaible_sku, 'no' ); ?> /> <?php esc_html_e( 'No', 'hfd-integration' ); ?>
						</div>
                    </td>
                </tr>
				<tr valign="top">
